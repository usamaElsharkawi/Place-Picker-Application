...
function App() {
  ...
  function handleUpdatePlaceError() {
    setErrorUpdatingPlaces(null);
  }

  return (
    <>
      <Modal open={errorUpdatingPlaces} onClose={handleUpdatePlaceError}>
        {errorUpdatingPlaces && (
          <Error
            title="Error Occured!"
            message={errorUpdatingPlaces.message}
            onConfirm={handleUpdatePlaceError}
          />
        )}
      </Modal>
      ...
      <main>
        {error  ? (
          ...
          <Places
            ...
            loadingText="Fetching the user data..."
            places={userPlaces}
